...
<FileAllocation policy="New scripts are permissible, but validate against these first.">
    ...
    <Path="scripts/InventoryUI.js" purpose="Handles rendering of the inventory UI." />
    <Path="scripts/items.json" purpose="Definitions for all items, equipment, and loot tables." />
    <Path="scripts/Lobby.js" purpose="Handles the lobby UI and player input for starting/joining games." />
